    ...
    public class ParticipantsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Participant>> GetParticipant(int id)
        {
          if (_context.Participants == null)
          {
            ...
            var paticipant = await _context.Participants.FindAsync(id);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutPaticipant(int id, ParticipantResult _participantResult)
        {
        ...
        public async Task<IActionResult> DeleteParticipant(int id)
        {
            ...
            _context.Participants.Remove(paticipant);
            await _context.SaveChangesAsync();

            return NoContent();
        }

        private bool PaticipantExists(int id)
        {
